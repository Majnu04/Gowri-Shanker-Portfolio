    ...
    <section id="experience" className="py-20 px-4">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="relative">
          ...
          >
            {/* Timeline Dot */}
            <div className="absolute left-6 md:left-1/2 transform md:-translate-x-1/2 w-5 h-5 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full border-4 border-slate-900 z-10" />
            
            <Card className="ml-16 md:ml-0 md:w-1/2 bg-slate-800/50 border-slate-700/50 hover:border-blue-500/50 transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/10">
